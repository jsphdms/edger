...
#' @param reflect Boolean specifying whether to relect tile in the y axis (i.e.
#'     turn upside down)
...
#'                        y = c(h, r, h))
#'
#' put_tile(tile = big_tile, reflect = TRUE, x = .125)

put_tile <- function(tile_in, scale = .25, reflect = FALSE,
                           x = 0, y = 0) {
